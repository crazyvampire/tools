...
/**
 * 基于BigDecimal类，对double浮点数进行加、减、乘、除基本运算的封装
 */
public class Arith {
    // 默认除法运算精度
    ...
    public static void main(String[] args) {
        ...
        if (str.split("\\.")[1].length() >= 5) {
            System.out.println(str.split("\\.")[0] + "." + str.split("\\.")[1].substring(0, 5));
        } else {
            System.out.println(num);
        }

        System.out.println(round(31352.229999999803, 4));
        System.out.println(formatDouble(31352.229999999803, "#0.####", ".0000"));
